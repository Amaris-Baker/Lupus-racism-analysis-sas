...
proc sort data=abaker.merge1_a;
by record_id;
run;

proc sort data=abaker.merge2_a;
by record_id;
run;

proc sort data=abaker.merge3_a;
by record_id;
run;

data abaker.leap_long;
   set abaker.merge1_a abaker.merge2_a abaker.merge3_a;
run;

data abaker.leap_long_clean;
  set abaker.leap_long;
  where leap_online_survey_complete NE 0;
run;

proc sort data= abaker.leap_long_clean;
by record_id;
run;
